<div class="card-body t-p-0">
    <section class="t-bg-gradient-to-br t-from-slate-900 t-via-slate-800 t-to-emerald-800 t-text-white t-rounded-2xl t-p-8 t-p-md-10 t-relative t-overflow-hidden">
        <div class="t-max-w-2xl">
            <span class="badge text-bg-light t-text-slate-900 t-font-semibold t-mb-4">ADMIN LOGIN</span>
            <h1 class="display-6 fw-bold t-leading-tight t-mb-3">Admin belépés</h1>
            <p class="lead t-text-slate-200 t-mb-0">Add meg az admin belépési adataidat.</p>
        </div>
    </section>
        ...
        <div class="card-body">
            <form method="POST" action="/admin/login" class="row g-3">
                <div class="col-12">
                    ...
                    <input class="form-control" id="email" name="email" type="email" value="<?= htmlspecialchars(oldValue('email', ''), ENT_QUOTES, 'UTF-8') ?>" placeholder="admin@domain.hu" required>
                ...
                <div class="col-12 d-flex align-items-center justify-content-between">
                    ...
                    <a class="text-decoration-none t-text-emerald-600 t-font-semibold" href="/admin/forgot-password">Elfelejtett jelszó?</a>
                </div>
                <div class="col-12">
